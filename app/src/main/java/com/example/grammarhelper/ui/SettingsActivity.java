...
public class SettingsActivity extends AppCompatActivity {
    ...
    private AlertDialog currentDialog; // Track current dialog to prevent leaks
            ...
            spinnerTheme.setOnItemSelectedListener(new android.widget.AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(android.widget.AdapterView<?> parent, android.view.View view, int position, long id) {
                    if (position != prefs.getInt(KEY_THEME, 0)) {
                        ...
                        // Show restart dialog (fixed version)
    ...
    protected void onDestroy() {
        // Dismiss any pending dialog to prevent window leak
        if (currentDialog != null && currentDialog.isShowing()) {
            currentDialog.dismiss();
            currentDialog = null;
        }
