...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        // Re-check theme when returning to activity
        checkThemeMode();
        refreshCharts();
    }
    ...
    private void setupPieChart() {
        ...
        if (isDarkMode) {
            ...
            errorPieChart.setEntryLabelColor(Color.parseColor("#B0B0B8"));
        } else {
            errorPieChart.setCenterTextColor(Color.parseColor("#1A1A2E"));
            errorPieChart.setHoleColor(Color.parseColor("#FFFFFF"));
            errorPieChart.setEntryLabelColor(Color.parseColor("#6C757D"));
        }
